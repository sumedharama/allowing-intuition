...
Ajahn Buddhadāsa -- um monge tailandês muito conhecido e cujo nome significa o
...
O Caminho Óctuplo começa com \emph{sammā-diṭṭhi} (visão correta) -- a premissa
...
O segundo fator do Caminho é \emph{sammā-saṅkappa} -- por vezes traduzido como
``pensamento correto'' -- mas diria que uma tradução mais próxima do seu
verdadeiro significado seria ``resolução correta''.

Há uma opção que se toma. E esta ``resolução correta'' é ``\emph{sammā}'', que
...
Sangha. \emph{Sammā-saṅkappa} consiste no pensamento ou na resolução que se
...
Os seres humanos têm a capacidade de direcionar o pensamento e de orientarem
...
porque o termo \emph{diṭṭhi} inclui a forma como olhamos para as coisas, e o
...
erros dos outros -- chama-se a isso ``educarmo-nos a nós próprios''. Portanto,
partir do pressuposto que não sabemos tudo, é útil; conseguirmos reconhecer tal
facto é uma faculdade em si: saber que não sabemos.
...
outros estamos a dessensibilizarmo-nos imediata e diretamente. Quando nos
deixamos levar pela satisfação dos sentidos, estamos a sobrecarregar os sentidos
ao ponto de os tornar dormentes, estamos a dessensibilizarmo-nos, tal como
...
\emph{Ajahn Vajiro:} Já aqui referi Ajahn Buddhadāsa e o seu comentário que
...
assola habitualmente?''. Ajahn Buddhadāsa não deu uma resposta direta, o que
...
determinada pessoa seja nossa amiga ou a/o parceira/o perfeita/o, estamos a
...
vez, recordo Ajahn Budhadāssa: ``Alegria, finalmente: saber que não existe
felicidade neste mundo!'' Se nos pomos a procurar a felicidade no lugar errado,
...
a pensar: ``A felicidade de agora poderá desaparecer, terminar ou poderá surgir
dor no futuro''.
...
Buddhadāsa que partilhei: ``Que alegria finalmente, saber que não existe
...
Todos estes aspetos são facetas daquilo a que chamamos de \emph{brahma-vihāras}:
a bondade amorosa, a compaixão, a alegria e a serenidade -- \emph{mettā, karuṇā,
  muditā, upekkhā}. São a expressão natural de um coração liberto da ignorância.
...
intoxicam. E quando o fazem, é porque estão confusos de alguma forma. A alegria
...
positivo, e dêem-lhe força. Neste gesto de dar força àquilo que apoia e aumenta
o Bem e a sabedoria é aquilo que se chama ``esforço correto'', e este, requer
...
andamento, estamos a praticar o Caminho Óctuplo: Visão Correta, Intenção
Correta, Pensamento Correto, Ação Correta, Modo de Vida Correto, Esforço
Correto, Consciência Correta, e Concentração Correta. Pratiquem o Caminho
Óctuplo, porque é este que tornará as vossas vidas em algo com valor. Este é o
...
A Visão Correta (\emph{sammā-diṭṭhi}) consiste na constatação das Quatro Nobres
...
de separação entre eu e tu, a vontade de manipular aquilo que é exterior a mim,
...
\emph{sammā-samādhi}. Nas escrituras surge relacionada com as quatro
\emph{jhānas}. Estas quatro \emph{jhānas} são descritas com mais detalhe nos
comentários, mas não tanto nas escrituras. Portanto pode existir alguma
controvérsia sobre o conceito de \emph{jhāna}. E, contudo, se quisermos abreviar
a questão, de acordo com os comentários, a prática das \emph{jhānas} está
...
\emph{samādhi}. É um tema que vale a pena investigar. Em geral, não costumo
...
ensinamentos do Buda em relação ao conceito de ``não-eu'' (anattā) focam-se na
ideia de não levarmos esta matéria viva, ou mesmo esta vida, de modo pessoal. A
forma, a sensação, a perceção, a conceção e a consciência manifestam-se, e são
...
sensação, perceção, conceito, ou consciência, ``eu'', se levarmos estes fatores
